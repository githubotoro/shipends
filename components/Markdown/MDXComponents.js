...
const MDXComponents = {
    ...
    p: (props) => {
        return <div className="mb-3 text-md" {...props} />;
    },
    em: (props) => {
    ...
    blockquote: (props) => {
        return (
            <blockquote className="mb-3 border-l-4 border-borderDefault tracking-wide bg-canvasInset rounded-r-lg py-2">
                <div className="mt-2 ml-3 text-fgMuted mr-3" {...props} />
            </blockquote>
        );
    },
    li: (props) => {
    ...
    pre: (props) => {
        return (
            <pre className="mb-3 bg-canvasInset py-2 px-4 rounded-md overflow-x-auto">
